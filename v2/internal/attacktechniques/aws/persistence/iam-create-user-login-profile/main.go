...
import (
	...
	utils2 "github.com/datadog/stratus-red-team/v2/internal/utils"
...
func detonate(params map[string]string) error {
	...
	password := utils2.RandomString(16) + ".#1Aa" // extra characters to ensure we meet password requirements, no matter the password policy
	...
	accountId, _ := utils2.GetCurrentAccountId(providers.AWS().GetConnection())
