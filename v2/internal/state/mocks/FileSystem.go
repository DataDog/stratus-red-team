...
// IsDirectory provides a mock function with given fields: _a0
func (_m *FileSystemMock) IsDirectory(_a0 string) bool {
	ret := _m.Called(_a0)
...
func (_m *FileSystemMock) ListDirectory(_a0 string) ([]string, error) {
	ret := _m.Called(_a0)
...
func (_m *FileSystemMock) RemoveAll(_a0 string) error {
	ret := _m.Called(_a0)
...
// RemoveEmptyDirectory provides a mock function with given fields: _a0
func (_m *FileSystemMock) RemoveEmptyDirectory(_a0 string) error {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for RemoveEmptyDirectory")
	}
...
func (_m *FileSystemMock) Rename(_a0 string, _a1 string) error {
	ret := _m.Called(_a0, _a1)
